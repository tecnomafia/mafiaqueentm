...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './mafiya.db' : process.env.DATABASE_URL;
DEBUG = process.env.DEBUG === undefined ? false : convertToBool(process.env.DEBUG);

module.exports = {
    VERSION: 'rs-mafiya-king 2.0.0 - Full Control',
    CHANNEL: 'https://t',
    SESSION: process.env._mafiya_QUEEN_SESSION === undefined ? '' : process.env._SEW_QUEEN_SESSION,
    ...
    ABT: process.env.AUTO_BİO_ABOUT === undefined ? 'Coded By mafiya' : process.env.AUTO_BİO_ABOUT,
